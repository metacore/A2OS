/* Timothee: I found this in:
 *     http://lists.denx.de/pipermail/u-boot/2014-April/178227.html
 * It is an old (and more simple version of the Xilinx linux USB driver.
 * Overview of the commit diff:
 *
